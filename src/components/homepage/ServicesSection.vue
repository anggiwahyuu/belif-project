    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Layanan</h2>
          <p>Belif menyediakan layanan terkait kesehatan mental terbaik di Indonesia dengan fitur terlengkap dan dukungan support 24 jam untuk kemudahan Anda dalam mengatasi kesehatan mental.</p>
        </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <ul class="text-start mb-3">
                ...
                <li>Fitur pelacakan kesehatan mental dan pemantauan perasaan.</li>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <ul class="text-start" style="margin-bottom: 100px">
                ...
                <li>Konten eksklusif yang diperbarui secara berkala.</li>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <ul class="text-start">
                ...
                <li>Materi eksklusif dari ahli kesehatan mental.</li>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <ul class="text-start">
                ...
                <li>Pelatihan dan seminar online tentang manajemen stres, keseimbangan kerja - kehidupan, dan strategi kesehatan mental.</li>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <ul class="text-start" style="margin-bottom: 75px;">
                ...
                <li>Konsultasi online dengan konselor pendidikan untuk membantu mengatasi masalah akademik dan personal.</li>
